...
public class DriveTrain extends SubsystemBase {
    ...
    public DriveTrain() {
        m_left1 = new WPI_TalonFX(Constants.m_left1);
        m_left2 = new WPI_TalonFX(Constants.m_left2);
        m_right1 = new WPI_TalonFX(Constants.m_right1);
        m_right2 = new WPI_TalonFX(Constants.m_right2);
